...
Gui, Add, Picture,w27 h30 xm+2 ym+70         gTabSP, SugiPula\Icon&Menu\sp.png
Gui, Add, Picture,w27 h30 xm+2 ym+110         gTabSS, SugiPula\Icon&Menu\ss.png
Gui, Add, Picture,w27 h30 xm+2 ym+150         gTaball41, SugiPula\Icon&Menu\frost.png
Gui, Margin, 80, 50
...
Gui, Add, DDL, w150 ym+65 xm     vSP4           ,2-0|Scalar+Inventory|Strave
...
Gui, Add, Text,ym+110 xm-40             vSP15      ,- Equip combat when u start the macro !
...
Treadmill:
    ...
    Loop,
    {
        ...
        Loop,
        {
            Loop, Parse, Button, `,
            {
                ImageSearch,,, 200, 240, 600, 300, *50 SugiPula\TrainingIcon\%A_LoopField%.bmp
                If (ErrorLevel = 0) {
...
Weight:
    ...
    Loop,
    {
        ...
        Loop,
        { 
            ImageSearch,x, y, 250, 220, 570, 470, *20 SugiPula\TrainingIcon\WeightButton.bmp
            If (ErrorLevel = 0) {
                SetMouseDelay, -1
                MouseMove, x, y, 0
                MouseMove, x+1, y+1, 0
        ...
        If (W4 = "Inventory") or (W4 = "1-0") or (W4 = "Protein+Inventory") {
            If (W4 = "Protein+Inventory") {
                ...
                ImageSearch,,, 0, 145, 70, 170, *10 SugiPula\BasicUI\DrinkStatus1.bmp
                If (ErrorLevel = 1) {
...
SP:
    ...
    Loop,
    {
        ...
        ImageSearch,,, 20, 120, 260, 140, *10 SugiPula\BasicUI\Stamina.bmp
        If (ErrorLevel = 0) {
            Sleep, 1000
            ...
            {
                Switch SP8 {
                    case "Fast"     : ErrLevel := GetColors(145, 130, "0x3A3A3A", 20)
                    case "Medium"   : ErrLevel := GetColors(165, 130, "0x3A3A3A", 20)
                    case "Slow"     : ErrLevel := GetColors(185, 130, "0x3A3A3A", 20)
                }
                If (ErrLevel) {
        ...
        If (SP4 != "Strave") {
            ...
            ImageSearch,,, 50, 135, 55, 150, *30 SugiPula\BasicUI\Hunger.bmp
            If (ErrorLevel = 0) {
                SendInput, % sw("Shift")
                Switch Eat(i, SP4) {
...
SS:
    ...
    Loop,
    {
        ...
        ImageSearch,,, 60, 525, 750, 590, *40 SugiPula\BasicUI\Speed.bmp
        If (ErrorLevel = 0) {
            ...
            Loop,
            {
                ...
                Sleep 1000
                ImageSearch,,, 65, 525, 750, 585, *40 SugiPula\BasicUI\Speed.bmp
