...
Gui, Add, Button, w100 x356 y250      vSP15   gSP    ,Done
Gui, Add, Text,ym+190 xm-230             vSP16      ,- Equip combat when u start the macro !
...
SP:
    ...
    Gui, Destroy
    global Shiftlock = "on"
    CheckVars([SP2, SP4, SP6, SP8, SP10, SP12, SP14], "StrikePower")
    if (SP12 = "Video") {
        Gui, 3:Add, Text, y10,Record Key:
        Gui, 3:Add, DDL, +Theme ym vKeyCombo , Win+Alt+G|F8|F12
        Gui, 3:Add, Button, ym gRecorder, Done
...
muscle:
    ...
    Gui, Add, DDL, w150 ym+65 xm vv2,Protein+Inventory|2-0|Starve
    ...
    SetTimer, %Tagfunc% , 1000
        Round++
            If (v3 = "Fatigue Estimate") {
                ...
                if (v3 = "Fatigue Estimate") {
                Sleep 150
                Message("Pushup & Squat - ***Round # ***" Round)
                }
                If (Round >= MaxRound) {
                    Ping("Max round has reached") Exit(v4)
                }
            }
        Click, 65, 470
