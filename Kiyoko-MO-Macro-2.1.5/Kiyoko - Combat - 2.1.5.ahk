...
Gui, Add, Text,x35 y10 w650 h50 +BackgroundTrans Center gMove, Version: %Version%  Version: %A_AhkVersion%
        ...
        If (ErrorLevel = 0) {
            ...
            Loop,
            {
                ...
                If (A_TickCount- TimerN > 60000) {
                    Ping("you got pushed / taking longer time than usual")
                }
            } Until (ErrorLevel = 1) 
            Sendinput, % sw("1")
            Switch SS2 {
